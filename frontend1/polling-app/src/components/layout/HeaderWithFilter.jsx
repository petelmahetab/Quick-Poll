  ...
  return (
    <div>
      <div className="flex items-center justify-between">
        <h2 className="sm:text-xl font-medium text-white">Your Polls</h2>

        <button
          className={`flex items-center gap-3 text-sm text-white bg-gray-700 hover:bg-gray-900 px-5 py-2 rounded-lg shadow-md transition-all duration-300 ease-in-out
